...
- [能力一览](#能力一览) · [环境要求](#环境要求) · [安装 SDK](#安装-sdk)
- [隐私与合规](#隐私与合规) · [初始化与请求配置](#初始化与请求配置) · [通用接入范式](#通用接入范式)
- 广告类型：[开屏](#开屏广告-splash) · [Banner](#banner-广告) · [插屏](#插屏广告-interstitial) · [信息流](#信息流广告-native-feed) · [激励视频](#激励视频广告-reward)
- [服务端竞价与 Header Bidding](#服务端竞价与-header-bidding) · [错误码](#错误码)
- [公开库与定制库差异](#公开库与定制库差异) · [最佳实践](#最佳实践) · [常见问题](#常见问题) · [版本与支持](#版本与支持)
